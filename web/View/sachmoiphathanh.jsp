...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE HERE ============================================= -->
        <title>Sách mới phát hành</title>
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Sách mới phát hành</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <c:forEach items="${sachmoiphathanh}" var="smph">
                                        <div class="blog-post blog-md clearfix">
                                            ...
                                            <div class="ttr-post-info">
                                                <ul class="media-post">
                                                    <li><a href="#"><i class="fa fa-calendar"></i>${smph.getNam_xuat_ban()}</a></li>
                                                    <li><a href="#"><i class="fa fa-user"></i>${smph.getTac_gia()}</a></li>
                                                </ul>
                                                <h5 class="post-title"><a href="blog-details.html">${smph.getTen_sach()}</a></h5>
                                                <p>${smph.getMo_ta()}</p>
                                                <div class="post-extra">
                                                    <a href="DetailController?id_sach=${smph.getId_sach()}" class="btn-link">READ MORE</a>

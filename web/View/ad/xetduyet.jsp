        ...
        <div class="row">
            ...
            <div class="col-lg-12 m-b30">
                ...
                <div class="widget-box">
                    ...
                    <c:forEach items="${listChuaXetDuyet}" var="item">   
                            ...
                            <div class="card-courses-list admin-review">
                                <div class="card-courses-full-dec">
                                    ...
                                    <div class="row card-courses-dec">
                                        <div class="col-md-12">
                                            <h6 class="m-b10"></h6>
                                            <p> ${item.nhan_xet_cua_user} </p>	
                                        </div>
                                        <div class="col-md-12">

                                            <a href="DuyetSachController?id_cmt=${item.id_cmt}" class="btn">Duyệt</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

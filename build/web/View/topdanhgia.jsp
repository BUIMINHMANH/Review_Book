                        ...
                        <div class="container clearfix">
                            ...
                            <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                                ...
                                <ul class="nav navbar-nav">	
                                    ...
                                    <li><a href="TheLoaiController">Top đánh giá <i class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Top Đánh Giá</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                ...
                <div class="content-block">
                    <div class="section-area section-sp1">
                        <div class="container">
                            <div class="row">
                                <!-- Left part start -->
                                <c:forEach items="${listTopDanhGia}" var="item">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="blog-post blog-md clearfix">
                                            ...
                                            <div class="ttr-post-info">
                                                <ul class="media-post">
                                                    ...
                                                    <li><a href="#"><i class="fa fa-star"></i>${item.trung_binh_danh_gia}</a></li>
                                                    <li><a href="#"><i class="fa fa-user"></i>${item.tac_gia}</a></li>
                                                </ul>
                                                <h5 class="post-title"><a href="blog-details.html">${item.getTen_sach()}</a></h5>
                                                <p>${item.getMo_ta()}</p>
                                                <div class="post-extra">
                                                    <a href="DetailController?id_sach=${item.getId_sach()}" class="btn-link">READ MORE</a>
                                                    <a href="#" class="comments-bx"><i class="fa fa-comments-o"></i>${item.luot_danh_gia} Comment</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Pagination start -->
